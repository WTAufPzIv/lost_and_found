      ...
      ajax.request({
        ...
        success: function (res) {
          ...
          if (res.code == 200) {
            ...
            wx.hideLoading()
            wx.navigateTo({
              url: '../add/add?title=' + res.data.subject + '&address=' + res.data.address + '&phone=' + res.data.contactInformation + '&time=' + res.data.date + '&detail=' + res.data.detail + '&addClass=right' + '&id=' + id + '&img=' + JSON.stringify(res.data.imageUrlList) + '&mode=set',
            })
          }
        }
      })
